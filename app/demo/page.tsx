                    ...
                    {realTimeData.map((fund) => (
                      ...
                      >
                        ...
                        <div className="text-right">
                          ...
                          <Badge
                            variant={
                              fund.performance > 10 ? "success" : "warning"
                            }
                          >
                  ...
                  <ScrollArea className="h-[300px]">
                    <div className="space-y-4">
                      {realTimeData
                        ...
                        .map((holding) => (
                          <div
                            key={`${holding.fundName}-${holding.name}`}
                            className="flex items-center justify-between p-4 bg-slate-50 rounded-lg"
                          >
                            <div>
                              <p className="font-medium">{holding.name}</p>
                              <p className="text-sm text-slate-500">
                                {holding.fundName} • {holding.sector}
                              </p>
                            </div>
                            <div className="text-right">
                              <p className="font-medium">
                      ...
                      <thead>
                        <tr>
                          ...
                          {realTimeData
                            ...
                            .map((holding) => (
                              <th key={holding.name} className="text-right p-2">
                                {holding.name}
                              </th>
                            ))}
                        </tr>
                            ...
                            <tr key={holding1.name}>
                              ...
                              {realTimeData
                                ...
                                .map((holding2) => {
                                  ...
                                  return (
                                    <td
                                      key={`${holding1.name}-${holding2.name}`}
